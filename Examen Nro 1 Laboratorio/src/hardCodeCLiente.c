...
void cliente_HardcodDatosArray(Cliente list[], int len)
{
    ...
    char nombre_Cliente[QTY_CLIENTES][LONG_NAME_CLIENTES]= {"Nicolas","Nicolas","Pedro","Juan","Marcelo"};
    char apellido_Cliente[QTY_CLIENTES][LONG_NAME_CLIENTES]= {"A_Letticugna","E_Dominguez","C_Gonzalez","Z_Dominguez","E_Dominguez"};
