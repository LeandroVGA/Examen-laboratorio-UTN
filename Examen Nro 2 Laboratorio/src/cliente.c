...
Cliente* cliente_newParamTxt(char* idCliente,char*nombreCliente,char*apellidoCliente,char*cuitCliente)
{
	Cliente* this = NULL;
	this = cliente_new();
	if(this != NULL && idCliente != NULL && nombreCliente != NULL && apellidoCliente != NULL && cuitCliente != NULL)
	{
		if(	cliente_setNombreCliente(this,nombreCliente) == -1 ||
			cliente_setIdClienteTxt(this,idCliente) == -1 ||
			cliente_setApellidoCliente(this,apellidoCliente) == -1 ||
			cliente_setCuitCliente(this, cuitCliente) == -1)
		{
			cliente_delete(this);
			this = NULL;
		}
